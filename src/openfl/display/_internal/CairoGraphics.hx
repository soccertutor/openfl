...
class CairoGraphics
{
	...
	private static function createGradientPattern(s:CairoGraphicsState, type:GradientType, colors:Array<Dynamic>, alphas:Array<Dynamic>, ratios:Array<Dynamic>, matrix:Matrix,
		...
		for (type in commands.types)
		{
			switch (type)
			{
				...
				case BEGIN_SHADER_FILL:
					...
					{
						if (shaderBuffer.inputs[0].readable)
						{
							s.fillPattern = createImagePattern(s, shaderBuffer.inputs[0], null, shaderBuffer.inputWrap[0] != CLAMP,
